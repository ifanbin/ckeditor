...
public class ContentController {
    ...
    @ResponseBody
    public UploadImageModel uploadImage(@RequestParam("upload") MultipartFile multipartFile) {
        UploadImageModel res = new UploadImageModel();
        res.setUploaded(0);
        ...
        String fullPath = "F:/upload/".concat(newFileName);
